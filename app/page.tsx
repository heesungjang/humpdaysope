  ...
  return (
    <main className="flex h-screen flex-col items-center  p-24 justify-center lg:justify-start">
      <div className="z-10 max-w-5xl w-full items-center justify-between font-mono text-sm  lg:flex">
        ...
        <div className="fixed bottom-0 left-0 flex h-48 w-full items-end justify-center bg-gradient-to-t from-white via-white dark:from-black dark:via-black lg:static lg:h-auto lg:w-auto lg:bg-none sm:hidden lg:block transition-all">
      ...
      <div className="w-full flex  max-w-5xl sm:justify-center lg:justify-start">
        <Link
          ...
          className={`text-xl font-semibold mt-14 group rounded-lg border border-transparent px-5 py-4 transition-colors border-gray-300 bg-gray-100 dark:border-neutral-700 dark:bg-neutral-800/30`}
        >
          Spin the Wheel 🎡
        </Link>
      </div>
